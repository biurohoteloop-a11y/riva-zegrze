...
const apartmentData = {
  name: 'Apartament D7',
  tagline: 'Przestronny i funkcjonalny apartament z tarasem',
  subtitle: 'Położony na 3 piętrze w obiekcie Riva Zegrze',
  price: {
    from: 540,
    currency: 'zł',
    period: 'noc',
  ...
  description: `Przestronny i funkcjonalny apartament z tarasem, położony na 3 piętrze w obiekcie Riva Zegrze. 
    Idealny wybór na komfortowy wypoczynek nad wodą, z dostępem do strefy rekreacyjnej i terenów zielonych.`,
  
  fullDescription: `Apartament o powierzchni 38 m² przeznaczony jest dla maksymalnie czterech osób i zapewnia komfortowe warunki zarówno na krótki pobyt, jak i dłuższy wypoczynek. W apartamencie znajduje się oddzielna sypialnia z łóżkiem podwójnym, salon z rozkładaną sofą, praktyczny aneks kuchenny oraz prywatna łazienka z prysznicem. Wnętrze jest jasne, nowoczesne i zaprojektowane w sposób sprzyjający wygodnemu użytkowaniu.

Atutem apartamentu jest taras położony na 3 piętrze, który pozwala odpocząć na świeżym powietrzu i cieszyć się spokojną atmosferą obiektu.`,

  aboutProperty: {
    title: 'O obiekcie',
    paragraphs: [
      'Apartament znajduje się na terenie Riva Zegrze, kompleksu położonego bezpośrednio przy plaży nad Jeziorem Zegrzyńskim. Goście mogą korzystać z krytego, podgrzewanego basenu, siłowni, prywatnej plaży, mariny oraz zaplecza do sportów wodnych.',
      
      'Okolica sprzyja aktywnemu wypoczynkowi — dostępne są trasy spacerowe i rowerowe, kajaki, rowerki wodne, a w niewielkiej odległości znajduje się pole golfowe w Rajszewie. Dogodny dojazd z Warszawy sprawia, że apartament stanowi doskonałą bazę wypoczynkową nad wodą.'
    ],
    features: [
      {
        icon: MapPin,
        title: 'Lokalizacja',
        description: 'Bezpośrednio przy plaży nad Jeziorem Zegrzyńskim, 3 piętro z widokiem.'
      },
      {
        icon: Droplets,
        title: 'Basen',
  ...
  highlights: [
    { icon: Home, label: 'Taras', description: 'Prywatny taras na 3 piętrze' },
    { icon: MapPin, label: '3 piętro', description: 'Piękne widoki' },
  ...
  gallery: [
    '/images/gallery/apartments/d7/D7.jpg',
    '/images/gallery/apartments/d7/D7-2.jpg',
    '/images/gallery/apartments/d7/IMG_3614.jpg',
    '/images/gallery/apartments/d7/IMG_3615.jpg',
    '/images/gallery/apartments/d7/IMG_3616.jpg',
    '/images/gallery/apartments/d7/T3S-RivaZegrze-3296-m.jpg',
],
  ...
  reviews: [
    {
      ...
      date: 'Grudzień 2024',
      rating: 5,
      comment: 'Wspaniały apartament na 3 piętrze! Widoki niesamowite. Wszystko czyste i komfortowe. Polecamy!',
      avatar: 'PK'
    },
    {
      ...
      date: 'Listopad 2024',
      rating: 5,
      comment: 'Świetne miejsce na wypoczynek. Basen, siłownia, marina - wszystko pod ręką. Wrócimy!',
      avatar: 'TL'
    },
    {
      name: 'Monika Wójcik',
      ...
      rating: 5,
      comment: 'Idealne na weekend! Taras piękny, apartament przestronny. Bardzo polecamy!',
      avatar: 'MW'
    }
  ]
};
...
// MAIN COMPONENT
export default function ApartmentD7Page() {
  return (
    <>
      <Navigation />
...
function HeroGallery() {
  const t = useTranslations('apartmentD7.hero');
...
function ApartmentDetails() {
  const t = useTranslations('apartmentD7.details');
  ...
  useEffect(() => {
      ...
      hotresScript.onload = () => {
        if (win.createHotres) {
          win.createHotres({
            oid: 5226,
            lang: 'pl',
            tid: '43219', // ✅ D7 apartment ID (wg Twojego wcześniejszego kodu)
    ...
    return () => {
      const scripts = document.querySelectorAll(
        'script[src*="hotres"], script[src*="jquery"]'
      );
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-28 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              ...
              <p className="text-base text-[#6e7a73] leading-relaxed font-light whitespace-pre-line">
                {t('fullDescription')}
              </p>
            </div>
                ...
                {[
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-white border border-[#d4d6ce] flex items-center justify-center mb-4 group-hover:border-[#AB8A62] group-hover:bg-gradient-to-br group-hover:from-[#f4e4c1] group-hover:to-[#AB8A62] transition-all">
                      <f.icon
                        className="w-6 h-6 text-[#4a6b5e] group-hover:text-[#8b6914] transition-colors"
                        strokeWidth={1}
                      />
                    </div>
                    <h4 className="text-base font-medium text-[#0f0e0f] mb-2">
                      {t(`aboutProperty.features.${f.i}.title`)}
                    </h4>
                    <p className="text-sm text-[#6e7a73] leading-relaxed font-light">
                      {t(`aboutProperty.features.${f.i}.description`)}
                    </p>
                  </div>
                ))}
              </div>
      ...
      {/* Premium calendar styles (bez zmian) */}
      <style jsx global>{`
...
function ImportantInfoSection() {
  const sectionRef = useRef<HTMLElement>(null);
  const t = useTranslations('apartmentD7.importantInfo');
...
function SurroundingsGallery() {
  ...
  const t = useTranslations('apartmentD7.surroundings');
    ...
    const initGSAP = async () => {
      if (typeof window !== 'undefined' && sectionRef.current) {
        try {
          ...
          const galleryItems =
            sectionRef.current.querySelectorAll('.surroundings-item');
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          <button
            ...
            className="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 flex items-center justify-content-center transition-all group"
            style={{ zIndex: 50 }}
...
function ReviewsSection() {
  const sectionRef = useRef<HTMLElement>(null);
  const t = useTranslations('apartmentD7.reviews');
...
function CTAWithFooter() {
  const t = useTranslations('apartmentD7');
