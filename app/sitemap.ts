...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { path: "/apartamenty/apartament-c1", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-c2", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-c4", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-c7", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-d1", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-d4", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-d7", priority: 0.8, changeFreq: "weekly" as const },
    { path: "/apartamenty/apartament-deluxe-b10", priority: 0.8, changeFreq: "weekly" as const },
